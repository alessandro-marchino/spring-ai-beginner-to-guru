...
@SpringBootTest
class GiveClearInstructionsTests {
    ...
    @Test
    void testCookSteak() {
        System.out.println(service.chat(directionsPrompt, Map.of("text_1", cookASteak)));
    }

    @Test
    void testBookDescription() {
        System.out.println(service.chat(directionsPrompt, Map.of("text_1", bookDescription)));
    }

    @Test
    void testCookSteakAsSnoopDog() {
        System.out.println(service.chat(directionsPrompt + " Give the directions using the tone of Snoop Dog", Map.of("text_1", cookASteak)));
    }

    @Test
    void testCookSteakAsHarryPotter() {
        System.out.println(service.chat(directionsPrompt + "Give the directions using the tone, tools and imagination of JK Rowling in a Harry Potter book", Map.of("text_1", cookASteak)));
    }

    @Test
    void testCookSteakAsTolkien() {
        System.out.println(service.chat(directionsPrompt + "Give the directions using the tone, tools and imagination of Tolkien in his Lord of the Rings book", Map.of("text_1", cookASteak)));
    }
