...
class InferenceTests {
    ...
    void testingSentiment() {
        System.out.println(service.chat(sentimentPrompt, Map.of(
            "review1", review1,
            "review2", review2,
            "review3", review3,
            "review4", review4,
    ...
    @Test
    void testingEmotion() {
        System.out.println(service.chat(emotionPrompt, Map.of(
            "review1", review1,
            "review2", review2,
            "review3", review3,
            "review4", review4,
    ...
    void testingForAnger() {
        System.out.println(service.chat(angerTestPrompt, Map.of(
            "review1", review1,
            "review2", review2,
            "review3", review3,
            "review4", review4,
    ...
    @Test
    void inferTopics() {
        System.out.println(service.chat(prompt, Map.of("story", story)));
    }
}
