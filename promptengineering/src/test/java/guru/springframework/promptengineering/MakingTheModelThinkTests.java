...
@SpringBootTest
class MakingTheModelThinkTests {
    ...
    String prompt = """
        ...
        4 - Output a json object that contains the following keys: italian_summary, num_names.
    ...
    @Test
    void testSteps() {
        System.out.println(service.chat(prompt, Map.of("text", story)));
    }
    ...
    void testIncorrectPrompt() {
        System.out.println(service.chat(prompt2Incorrect));
    }
    ...
    void testCorrectPrompt() {
        System.out.println(service.chat(prompt3Correct));
    }
    ...
    void testTheBallPrompt() {
        System.out.println(service.chat(prompt4));
    }
}
