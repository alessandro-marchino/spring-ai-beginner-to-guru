...
class SummarizingPromptsTests {
    ...
    void testCreateDescriptionFromReview() {
        System.out.println(service.chat(reviewPrompt, Map.of("review", review1)));
    }
    ...
    void testCreateDescriptionFrom3Reviews() {
        System.out.println(service.chat(reviewPrompt3, Map.of(
            "review", review1,
            "review2", review2,
            "review3", review3
        )));
    ...
    void testCreateDescriptionFrom3ReviewsExtract() {
        System.out.println(service.chat(reviewPrompt4, Map.of(
            "review", review1,
            "review2", review2,
            "review3", review3
        )));
