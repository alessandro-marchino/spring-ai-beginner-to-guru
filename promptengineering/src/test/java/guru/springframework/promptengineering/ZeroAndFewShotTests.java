...
class ZeroAndFewShotTests {
    ...
    void zeroShotPromptTest() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            System.out.println("#################################\n");
            System.out.println(service.chat(prompt, Map.of("review", UUID.randomUUID() + "\n" + review)));
        }
    }
    ...
    void zeroShotPromptTestWithModelOptions() {
        ...
        OllamaChatOptions chatOptions = OllamaChatOptions.builder()
            // default is 0.7, lower is more deterministic, higher is more creative
            .temperature(1.2)
            .build();
    ...
    void testwhatPuPromptFewShotTest() {
        System.out.println(service.chat(whatpuPrompt));
    }
    ...
    void testVacationFewShotTest() {
        System.out.println(service.chat(vacationPrompt));
    }
    ...
    void testMathPromptFewShotTest() {
        System.out.println(service.chat(mathPrompt));
    }

    @Test
    void AiHallucinationTest() {
        System.out.println(service.chat("Write sales copy for the new 'professional grade' " +
